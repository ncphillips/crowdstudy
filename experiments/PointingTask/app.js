...
/**
 * This app uses sockets to do things.
 *
 * @param config
 * @param server
 */
    ...
    io.on('connection', function (socket) {
        ...
        socket.on('init', function (PID) {
            ...
            var movefile = fs.open(moveLog, 'w', function (err) {
                ...
                fs.appendFile(moveLog, "PID; W; D; Wr; Dr; tot; Target; X; Y; Time; Browser; OS; Invisible; Block; WorkerID; Platform;\n");
            });
            ...
            var clickfile = fs.open(clickLog, 'w', function (err) {
                ...
                fs.appendFile(clickLog, "PID; W; D; Wr; Dr; tot; Target; Start; End; MouseDown; Error; Browser; OS; Invisible; Block; WorkerID; Platform;\n");
            });
        });
